...
def _map_omp_01_optional(
    ...
    Returns:
        ...
        process_analytics (dict): Summary of code mapping results.
    """
...
def map_omp_01_optional():
    ...
    The mapped OMP-01 tables are saved during this process, and process analytics are also saved as a JSON file.
    See '_map_omp_01_optional' for details.
    """
