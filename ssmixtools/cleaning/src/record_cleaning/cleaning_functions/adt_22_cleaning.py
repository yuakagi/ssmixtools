...
def _clean_adt_22(
    ...
    df = assign_unique_record_numbers(
        df, data_type_tag="adt22", file_tag=file_tag, pid=pid
    )
...
def clean_adt_22():
    """Cleans ADT-22 tables.
    See the helper function '_clean_adt_22' for the processing details.
    """
